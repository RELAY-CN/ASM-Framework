 ...
 * [ModifyArg]、[ModifyArgs]、[ModifyReceiver]、[Redirect]、[WrapOperation]、[WrapWithCondition] 与 [ModifyExpressionValue] 的调用路径也可复用
 ...
 * 普通 [AsmInject] 的 [InjectionPoint.INVOKE_STRING] 以及 [ModifyArg] / [ModifyArgs] / [ModifyReceiver] /
 * [Redirect] / [WrapOperation] / [WrapWithCondition] / [ModifyExpressionValue] 的调用路径支持 `ldc=<string>` 或
